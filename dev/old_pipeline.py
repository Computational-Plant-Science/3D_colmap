...
if __name__ == '__main__':
    ...
    ap.add_argument("-g", "--gpus", type=int, default=1, help="how many GPUs to use (set to 0 for CPUs-only)")
    ap.add_argument("-d", "--dense_strategy", required=False, type=str, default='COLMAP', help="whether to use PMVS or COLMAP for dense reconstruction")
